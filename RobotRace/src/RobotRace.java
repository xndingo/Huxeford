...
public class RobotRace extends Base {
    ...
    private class RaceTrack {
        ...
        public Vector getPoint(double t) {
            double angleInRad = 2*PI*t;
            return new Vector(8.5*Math.cos(angleInRad), 8.5*Math.sin(angleInRad), 0); // <- code goes here
        }
        ...
        public Vector getTangent(double t) {            
            double angleInRad = 2*PI*t;
            return new Vector(-8.5*Math.sin(angleInRad), 8.5*Math.cos(angleInRad), 0); // <- code goes here
        }
